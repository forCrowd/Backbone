...
export class AppHttp extends Http {
    ...
    constructor(connectionBackend: ConnectionBackend, private notificationService: NotificationService, requestOptions: RequestOptions) {
            ...
            switch (error.status) {
                ...
                case 400: { // Bad request
                    ...
                    if (body.ModelState) { // WebApi ModelState errors
                        ...
                        const odataErrors = body["odata.error"].innererror.message.split("\r\n") as string[];
