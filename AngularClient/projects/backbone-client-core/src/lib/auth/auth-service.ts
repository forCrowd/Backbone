...
export class AuthService {
  ...
  constructor(private appEntityManager: AppEntityManager,
    ...
    // Service urls
    this.currentUserUrl = config.serviceApiUrl + "/Account/CurrentUser";
    this.registerUrl = config.serviceApiUrl + "/Account/Register";
    this.tokenUrl = config.serviceApiUrl + "/Token";
  }
      ...
      return this.registerInternal(registerBindingModel).pipe(
        mergeMap(() => {
          return this.getToken("", "", true, this.currentUser.SingleUseToken).pipe(map(() => {
            this.notificationService.notification.next("Guest account has created");
          }));
        }));
    }
  }
