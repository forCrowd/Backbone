...
namespace forCrowd.Backbone.WebApi.Filters
{
    ...
    public class EntityExistsValidatorAttribute : ActionFilterAttribute
    {
        ...
        // TODO Whaa?
        private const string OWINDBCONTEXTKEY = "AspNet.Identity.Owin:forCrowd.Backbone.BusinessObjects.Entities.BackboneContext, forCrowd.Backbone.BusinessObjects, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
        ...
        private async Task Validate(HttpActionContext actionContext)
        {
            ...
            var dbContext = actionContext.Request.GetOwinContext().Get<BackboneContext>(OWINDBCONTEXTKEY);
