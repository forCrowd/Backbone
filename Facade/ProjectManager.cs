...
namespace forCrowd.Backbone.Facade
{
    ...
    {
        // Fields
        private readonly BackboneContext _context = new BackboneContext();
        ...
        public async Task UpdateComputedFieldsAsync(int projectId)
        {
            ...
            UpdateProjectComputedFields(project);
        ...
        private void UpdateProjectComputedFields(Project project)
        {
            // Rating count
