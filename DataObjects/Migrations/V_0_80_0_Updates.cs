...
namespace forCrowd.Backbone.DataObjects.Migrations
{
    ...
    {
        public static void Apply(BackboneContext context, User user)
        {
            CreateWealthEconomyOld(context, user);
        }

        private static void CreateWealthEconomyOld(BackboneContext context, User sampleUser)
        {
